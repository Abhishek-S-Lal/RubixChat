package com.abhishekslal.chat.android.Utils;
...
public class FirebaseMessagingService extends com.google.firebase.messaging.FirebaseMessagingService {
    ...
    public void onMessageReceived(RemoteMessage remoteMessage) {
        ...
        String NOTIFICATION_CHANNEL_ID = "RubixChat_Channel_1";

        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            NotificationChannel notificationChannel = new NotificationChannel(NOTIFICATION_CHANNEL_ID, "RubixChat Notifications", NotificationManager.IMPORTANCE_HIGH);
