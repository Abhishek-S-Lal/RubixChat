package com.abhishekslal.chat.android.Settings;
...
public class UserProfileEditActivity extends AppCompatActivity {
    ...
    private TextView  updatedMsg, recheckGender;
    private ImageView editPhotoIcon;
    private EditText display_name, display_email, user_phone, user_profession, user_nickname, display_status;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getUserDatabaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                display_status.setSelection(display_status.getText().length());
        ...
        saveInfoBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String uStatus = display_status.getText().toString();
                saveInformation(uName, uNickname, uPhone, uProfession, selectedGender, uStatus);
            }
        });
    ...
    private void saveInformation(String uName, String uNickname, String uPhone, String uProfession, String uGender, String uStatus) {
        if (uGender.length()<1){
        ...
        }else  if(TextUtils.isEmpty(uStatus)){
            SweetToast.warning(this,"Your status cannot be empty");
        }
        else {
            ...
            getUserDatabaseReference.child("user_status").setValue(uStatus);
                    ...
                    .addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            ...
                            new Timer().schedule(new TimerTask(){
                                public void run() {
                                    UserProfileEditActivity.this.runOnUiThread(new Runnable() {
                                        public void run() {
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == CropImage.CROP_IMAGE_ACTIVITY_REQUEST_CODE) {
            ...
            if (resultCode == RESULT_OK) {
                ...
                Task<Uri> uriTask = uploadTask.continueWithTask(new Continuation<UploadTask.TaskSnapshot, Task<Uri>>() {
                    ...
                    public Task<Uri> then(@NonNull Task<UploadTask.TaskSnapshot> task){
                        if (!task.isSuccessful()){
                            SweetToast.error(UserProfileEditActivity.this, "Profile Photo Error: " + task.getException().getMessage());
                    ...
                    public void onComplete(@NonNull Task<Uri> task) {
                        if (task.isSuccessful()){
                            ...
                            Task<Uri> thumbUriTask = thumb_uploadTask.continueWithTask(new Continuation<UploadTask.TaskSnapshot, Task<Uri>>() {
                                ...
                                public Task<Uri> then(@NonNull Task<UploadTask.TaskSnapshot> task){
                                    if (!task.isSuccessful()){
                                        SweetToast.error(UserProfileEditActivity.this, "Thumb Image Error: " + task.getException().getMessage());
                                    }
                ...
                // handling more event
                SweetToast.info(UserProfileEditActivity.this,"Image cropping failed.");
            }
        }
