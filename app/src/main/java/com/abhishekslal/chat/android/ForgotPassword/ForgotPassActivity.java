package com.abhishekslal.chat.android.ForgotPassword;
...
public class ForgotPassActivity extends AppCompatActivity {
    ...
    private void emailSentSuccessPopUp() {
        ...
        View view = LayoutInflater.from(ForgotPassActivity.this).inflate(R.layout.dialog_register_success, null);
